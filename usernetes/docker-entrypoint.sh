...
# rm -rf /home/${User}/.config/usernetes/containers/
# mkdir -p /home/${User}/.config/usernetes/containers/
# cp -r /etc/containers/ /home/${User}/.config/usernetes/containers/
# chown -R u7s-admin:u7s-admin /home/${User}/
