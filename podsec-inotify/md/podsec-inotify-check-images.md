...
В состав пакета входит файл для `cron` `/etc/podsec/crontabs/podsec-inotify-check-images`. Файл содержит единственную строку с описанием режима запуска скрипта `podsec-inotify-check-images`.
